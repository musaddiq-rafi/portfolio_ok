...
export function InfoGrid() {
  const features = [
    ...
    {
      title: "I prefer quality over quantity",
      description:
        "I'd rather have a few projects that I'm proud of than a lot of projects that I'm not.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Remote, Hybrid or Onsite - I'm in!",
      description:
        "I've no problem working remotely, hybrid, or onsite. I'm flexible.",
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-4 px-2 gap-4 max-w-xl mx-auto h-auto">
      <div className="w-full p-3 bg-white dark:bg-neutral-900 shadow-2xl group h-auto">
      <div className="flex flex-1 w-full h-auto flex-col space-y-2">
        <Image
        src="https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?q=80&w=2938&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="header"
        width={900}
        height={900}
        className="w-full h-auto object-cover object-left-top rounded-sm"
        />
      </div>
      </div>
...
export const SkeletonTwo = () => {
  const images = [
    ...
    "https://miro.medium.com/v2/resize:fit:1400/format:webp/1*LvA59wJi3O9jTMQQsw_cRA.png",
